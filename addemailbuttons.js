...
function addIndividualIssueButton() {
    chrome.runtime.sendMessage({ method: "getSettings", keys: ["emailIssue"] }, function (response) {
        if (response.data["emailIssue"]) {
...
function addButtonsToIssuesList() {
    chrome.runtime.sendMessage({ method: "getSettings", keys: ["emailIssuesList"] }, function (response) {
        if (response.data["emailIssuesList"]) {
